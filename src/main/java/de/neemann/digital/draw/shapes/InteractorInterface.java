...
public interface InteractorInterface {
     ...
     */
    void clicked(CircuitComponent cc, MouseEvent mouseEvent, Point pos, IOState ioState, Element element, SyncAccess modelSync);
     ...
     * @param modelSync used to sync model access
     */
    void pressed(CircuitComponent cc, MouseEvent mouseEvent, Point pos, IOState ioState, Element element, SyncAccess modelSync);
     ...
     * @param modelSync used to sync model access
     */
    void released(CircuitComponent cc, MouseEvent mouseEvent, Point pos, IOState ioState, Element element, SyncAccess modelSync);
     ...
     * @param modelSync   used to sync model access
     */
    void dragged(CircuitComponent cc, MouseEvent mouseEvent, Point posOnScreen, Vector pos, Transform transform, IOState ioState, Element element, SyncAccess modelSync);
